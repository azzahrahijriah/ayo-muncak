            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Edit Tour</h4>

                        <div class="card">
                            <h5 class="card-header">Form Edit Tour</h5>
                            <div class="card-body">
                                <form action="{{ route('admin.tour.update', $tour->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="id" name="id" class="form-select" required>
                                            ...
                                            <option value="{{ $gunung->id }}" {{ $tour->id === $gunung->id ? 'selected' : '' }}>
                                                {{ $gunung->nama }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="nama" name="nama" class="form-control" value="{{ old('nama', $tour->nama) }}" required />
                                    </div>
                                    <div class="mb-3">
                                        <label for="nohp" class="form-label">No HP</label>
                                        <input type="text" id="nohp" name="nohp" class="form-control" value="{{ old('nohp', $tour->nohp) }}" required />
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" id="email" name="email" class="form-control" value="{{ old('email', $tour->email) }}" required />
                                    </div>
                                    <div class="mb-3">
