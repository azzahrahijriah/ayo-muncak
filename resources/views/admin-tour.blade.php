<!DOCTYPE html>
<html lang="id" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-asset-path="{{ asset('asset/') }}" data-template="vertical-menu-template-free">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Data Tour</h4>

                        <!-- Tambah Tour Button -->
                        <a href="{{ route('admin.tour.create') }}" class="btn btn-primary">Tambah Tour</a>

                        <!-- Striped Rows -->
                        <div class="card">
                            <h5 class="card-header">Data Tour</h5>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{ route('admin.tour.edit', $tour->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                                        <form action="{{ route('admin.tour.destroy', $tour->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tour ini?');">
                                                            @csrf
                                                            @method('DELETE')
