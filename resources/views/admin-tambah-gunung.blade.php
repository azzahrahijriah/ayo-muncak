            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Tambah Gunung</h4>

                        <!-- Basic Forms -->
                        <div class="card">
                            <h5 class="card-header">Tambah Gunung</h5>
                            <div class="card-body">
                                <form action="{{ route('admin.gunung.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <!-- Form fields for adding a mountain -->
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.001" class="form-control" id="ketinggian" name="ketinggian" required>
                                    </div>
                                    <div class="mb-3">
