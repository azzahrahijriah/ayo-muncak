            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Data Pengalaman</h4>

                        <!-- Tambah Gunung Button -->
                        <a href="{{ route('admin.pengalaman.create') }}" class="btn btn-primary">Tambah</a>

                        <!-- Striped Rows -->
                        <div class="card">
                            <h5 class="card-header">Data Pengalaman</h5>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $pengalaman->tanggal }}</td>
                                            <td>{{ Str::limit($pengalaman->deskripsi, 50) }}</td>
                                            <td>
                                                <div class="dropdown">
