...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2025 at 07:52 AM
...
(1, 'admin', '$2y$12$xENpIKqbV5jNj3KAQY1hmeSsLng3woBCTMX5pd4pUkSlBRinUdT/K', '2024-06-30 22:58:11', '2024-06-30 22:58:11', NULL);
...
--
-- Table structure for table `favorit_gunung`
--

CREATE TABLE `favorit_gunung` (
  `id_favorit` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `favorit_gunung`
--

INSERT INTO `favorit_gunung` (`id_favorit`, `id_user`, `id_gunung`, `created_at`, `updated_at`) VALUES
(2, 1, 1, '2025-05-26 01:16:06', '2025-05-26 01:16:06'),
(3, 3, 1, '2025-05-26 19:41:39', '2025-05-26 19:41:39'),
(4, 1, 14, '2025-07-06 02:57:10', '2025-07-06 02:57:10');
...
(31, 'Jawa Tengah', 'guung', 555, 'Magelang', 'fadcsadv', '0.687604319815497', '101.57165186891552', 'Jalur Via Sawit, Jalur -jaluran', 4, 'gambar-gunung/default-image.jpg', NULL, NULL);
...
(15, '2024_07_01_101741_update_tour_table_add_auto_increment', 6),
(16, '2025_05_25_180132_add_remember_token_column_to_admin_table', 6),
(17, '2025_05_25_193423_add_detail_fields_to_pengalaman_table', 7);
...
CREATE TABLE `pengalaman` (
  ...
  `tanggal_pendakian` date DEFAULT NULL,
  `sampai_puncak` tinyint(1) NOT NULL DEFAULT 0,
  `tingkat_kesulitan` enum('Ringan','Sedang','Sulit','Lupa') DEFAULT NULL,
  `resiko_pendakian` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`resiko_pendakian`)),
...
INSERT INTO `pengalaman` (`id_pengalaman`, `id_user`, `id`, `tanggal`, `deskripsi`, `created_at`, `updated_at`, `tanggal_pendakian`, `sampai_puncak`, `tingkat_kesulitan`, `resiko_pendakian`, `catatan`) VALUES
(15, 1, 14, '2025-05-25', 'cackajsv\'coiaSNCL;KAsncaoi\'hvncosa;dkjxv ;sK>kjdpW\'ILHDFoew\'zdvlaw-{SP\"', '2025-05-25 20:46:49', '2025-05-25 20:46:49', '2025-05-03', 1, 'Ringan', '\"Keamanan Pendakian\"', 'cackajsv\'coiaSNCL;KAsncaoi\'hvncosa;dkjxv ;sK>kjdpW\'ILHDFoew\'zdvlaw-{SP\"'),
(16, 1, 1, '2025-06-19', 'wdasdc', '2025-06-19 07:24:51', '2025-06-19 07:24:51', '2025-06-14', 1, 'Lupa', '\"Kedinginan\"', 'wdasdc'),
(17, 1, 6, '2025-07-03', 'pengen kesini lagiiiiiii', '2025-07-03 08:33:50', '2025-07-03 08:33:50', '2024-06-03', 1, 'Ringan', NULL, 'pengen kesini lagiiiiiii');
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(555) DEFAULT 'default-avatar.jpg',
...
INSERT INTO `users` (`id_user`, `username`, `password`, `nama_lengkap`, `avatar`, `bio`, `instagram`, `tiktok`, `youtube`, `created_at`, `updated_at`) VALUES
(1, 'azzahrahijriah', '$2y$12$O.XVa2JnNiZqnrwMa7MHcOSxSI9DslNEFNCJhFt2SprDTCUZHuTAW', 'Az Zahra Hijriah', 'avatars/1748311441-tunazzatun.jpg', 'Bismillah yu bisa mendaki lagi', 'https://www.instagram.com/azzahrahijriah/', 'https://www.tiktok.com/@jarajaratun?is_from_webapp=1&sender_device=pc', 'https://www.youtube.com/@azzahrahijriah3855', '2025-05-25 07:32:35', '2025-06-18 07:47:12'),
(3, 'tunazzatun', '$2y$12$o6jGUazX9xaJ4luheD6O4OV35tytm40R/FC717AG/UeLRuBtdLFl6', 'ZahraTun', 'avatars/1748312353-tun.jpg', 'Tun', 'fcqaf', 'wwf', 'wqsf', '2025-05-26 01:30:16', '2025-05-26 19:19:13');
...
--
-- Indexes for table `favorit_gunung`
--
ALTER TABLE `favorit_gunung`
...
ALTER TABLE `pengalaman`
  ...
  ADD KEY `id` (`id`),
  ADD KEY `fk_pengalaman_user` (`id_user`);
...
--
-- AUTO_INCREMENT for table `favorit_gunung`
--
ALTER TABLE `favorit_gunung`
  MODIFY `id_favorit` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `pengalaman`
  MODIFY `id_pengalaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- Constraints for table `favorit_gunung`
--
ALTER TABLE `favorit_gunung`
  ADD CONSTRAINT `favorit_gunung_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE CASCADE,
  ADD CONSTRAINT `favorit_gunung_ibfk_2` FOREIGN KEY (`id_gunung`) REFERENCES `gunung` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `pengalaman`
--
ALTER TABLE `pengalaman`
  ADD CONSTRAINT `fk_pengalaman_user` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE CASCADE;
COMMIT;
